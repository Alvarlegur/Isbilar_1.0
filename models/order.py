...
class order:
    ...
    def __str__(self):
        return "\t{:>10}\t{:>10}\t{:>10}\t{:>10}\t{:>10}\t{:>15}\t\t{:>10}".format(self.__carID,self.__customerSSN, self.__dateOfHandover, self.__returnDate, self.__extraInsurance, self.__cardnum, self.__paymentMethod)
