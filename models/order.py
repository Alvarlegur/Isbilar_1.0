...
class order:
    ...
    def __str__(self):
        return "\t{:>5}\t{:>5}\t{:>5}\t{:>5}\t{:>5}\t{:>5}\t{:>10}\t{:>5}\t{:>5} \n".format(self.__orderID,self.__carID,self.__priceGroup, self.__dateOfHandover, self.__returnDate, self.__extraInsurance, self.__orderTotal, self.__cardnum, self.__paymentMethod)
